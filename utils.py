...
def generate_sim_time_seqs(time_seqs, seqs_length):
    ...
    # return sim_time_seqs, sim_index_seqs, restore_time_seqs, restore_sim_time_seqs
...
if __name__ == '__main__':
    ...
    # sim_time_seqs, sim_index_seqs = generate_sim_time_seqs(torch.stack([a,b]), torch.LongTensor([6,4]))
    sim_time_seqs, sim_index_seqs, restore_time_seqs, restore_sim_time_seqs = generate_sim_time_seqs(torch.stack([a,b]), torch.LongTensor([6,4]))
